...
export class GenerateSalariesService {
    ...
    public static saveSalaryItems(salaryItemsData: SalaryItem[]) {
        ...
        const queryParametersTaxes = [salaryItemsData[1].id, salaryItemsData[1].salary, salaryItemsData[1].name, salaryItemsData[1].quantity, salaryItemsData[1].direction, salaryItemsData[0].amount];
